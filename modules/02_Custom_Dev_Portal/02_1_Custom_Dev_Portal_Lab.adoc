...
In this lab you create API documents for the APIs managed by Red Hat 3scale API Management, learn about the Developer Portal and customization, and create a client application to consume the APIs exposed.

.Goals
* Create API documents for the Products API application
* Integrate the API documents with 3scale API Management
...
.. Click *Create Page*.
* You see the *Welcome* page in the *admin* section on the menu:
+
