...
For more information, see link:https://support.3scale.net/docs/api-documentation/create-activedocs-spec[Create a (Swagger) Spec].
...
See the link:https://support.3scale.net/docs/developer-portal/overview[Developer Portal Overview] for more information.
